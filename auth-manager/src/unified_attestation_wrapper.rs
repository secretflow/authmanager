...
#![allow(dead_code)]
use auth_types::{errno, AuthResult, AuthStatus, Error, ErrorLocation};
use unified_attestation::{ua_gen::*, ua_val::*};

use super::server::constant::*;
use log::info;
use std::ffi::{CStr, CString};

pub(crate) fn runified_attestation_verify_auth_report(
    auth_json: &str,
    rules_json: &str,
) -> AuthResult<()> {
...
pub(crate) fn runified_attestation_generate_auth_report(
    tee_identity: &str,
    report_type: &str,
